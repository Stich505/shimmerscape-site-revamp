    ...
    <footer className="glass py-8">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-foreground/80 mb-4 max-w-md">
              Creating beautiful digital experiences with cutting-edge technology and thoughtful design.
            </p>
            <div className="flex space-x-4">
              ...
              <a href="#" className="text-foreground/70 hover:text-shimmer-accent transition-colors" aria-label="Instagram">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#home" className="text-foreground/70 hover:text-shimmer-accent transition-colors">Home</a></li>
              <li><a href="#about" className="text-foreground/70 hover:text-shimmer-accent transition-colors">About</a></li>
              <li><a href="#projects" className="text-foreground/70 hover:text-shimmer-accent transition-colors">Projects</a></li>
              <li><a href="#contact" className="text-foreground/70 hover:text-shimmer-accent transition-colors">Contact</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start space-x-2">
                ...
                <span className="text-foreground/70">123 Design Street, Creative City</span>
              </li>
              <li className="flex items-start space-x-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-shimmer-accent mt-0.5">
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-foreground/60 text-sm">
          <p>© 2025 ShimmerScape. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
